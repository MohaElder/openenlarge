...
window.OE = (function () {
  var STRINGS = {
    en: {
      "meta.title": "OpenEnlarge — develop your film negatives with real physics",
      "meta.desc": "Open-source desktop darkroom for color film negatives. A physically-based, density-domain inverter — not a flipped tone curve.",
      "nav.features": "Features",
      "nav.how": "How it works",
      "nav.download": "Download",
      "nav.cta": "Download",
      "hero.eyebrow": "◆ Open source · density-domain",
      "hero.h1": "The physics of film,<br><span class=\"grad\">inverted properly.</span>",
      "hero.lede": "OpenEnlarge develops your color negatives with a real Beer-Lambert density model — not a flipped tone curve. A darkroom enlarger, reimagined as a desktop app.",
      "hero.dl": "↓ Download",
      ...
      "feat.decode.h3": "RAW & TIFF decode",
      "feat.decode.p": "Fuji RAF, DNG and 16-bit TIFF scans decoded to linear RGB, infrared plane preserved.",
      ...
      "feat.crop.h3": "Crop, rotate & export",
      "feat.crop.p": "Straighten and crop with a live histogram, then batch export to 16-bit TIFF, PNG or JPEG.",
    ...
    zh: {
      "meta.title": "OpenEnlarge — 用真实物理冲洗你的胶片负片",
      "meta.desc": "面向彩色胶片负片的开源桌面暗房。基于物理的密度域反转引擎，而非简单翻转色调曲线。",
      "nav.features": "功能",
      "nav.how": "原理",
      "nav.download": "下载",
      "nav.cta": "下载",
      "hero.eyebrow": "◆ 开源 · 密度域反转",
      "hero.h1": "胶片的物理，<br><span class=\"grad\">真正还原。</span>",
      "hero.lede": "OpenEnlarge 用真正的比尔-朗伯定律密度模型冲洗你的彩色负片，而不是翻转色调曲线。把暗房放大机重新构想为一款桌面应用。",
      "hero.dl": "↓ 下载",
      ...
      "feat.decode.h3": "RAW 与 TIFF 解码",
      "feat.decode.p": "将富士 RAF、DNG 和 16 位 TIFF 扫描解码为线性 RGB，并保留红外通道。",
      "feat.base.h3": "按胶卷的片基校准",
      "feat.base.p": "每卷只需采样一次橙色片基，即可应用到每一帧。",
      "feat.develop.h3": "完整的冲洗控制",
      "feat.develop.p": "色调曲线、调色、色轮、曝光、黑点与伽马——实时调整。",
      "feat.crop.h3": "裁剪、旋转与导出",
      "feat.crop.p": "借助实时直方图拉直和裁剪，然后批量导出为 16 位 TIFF、PNG 或 JPEG。",
      "feat.cli.h3": "无界面命令行",
